...
class MyCar  {
    ...
    */ 
    ...
    init() {
        ...
        const controlPoint = new THREE.Vector3(0.5, 1.1, 0); // Adjust the control point coordinates
        const controlPoint_2 = new THREE.Vector3(1.5, 1.1, 0); // Adjust the control point coordinates
        ...
        this.curveObject.position.set(-9.6,5.5,1)


        const startPoint2 = new THREE.Vector3(0, 0, 0);
        const controlPoint2 = new THREE.Vector3(0.5, 1.1, 0); // Adjust the control point2 coordinates
        const controlPoint2_1 = new THREE.Vector3(1.5, 1.1, 0); // Adjust the control point2 coordinates
        const endPoint2 = new THREE.Vector3(2, 0, 0);
        ...
        this.curveObject2.position.set(-9.6,5.5,-4)

        const startPoint3 = new THREE.Vector3(0, 2, 0);
        const controlPoint3_1 = new THREE.Vector3(1, 1.875, 0); // Adjust the control point2 coordinates
        const controlPoint3_2 = new THREE.Vector3(1.5, 1.6, 0); // Adjust the control point2 coordinates
        ...
        const startPoint4 = new THREE.Vector3(0.3, 1.85, 0);
        const controlPoint4_1 = new THREE.Vector3(1, 1.875, 0); // Adjust the control point2 coordinates
        const controlPoint4_2 = new THREE.Vector3(1.5, 1.6, 0); // Adjust the control point2 coordinates
        const endPoint4 = new THREE.Vector3(2.1, 0, 0);
        ...
        const startPoint5 = new THREE.Vector3(1, 3.85, 0);
        const controlPoint5_1 = new THREE.Vector3(2.5, 1.875*2, 0); // Adjust the control point2 coordinates
        const controlPoint5_2 = new THREE.Vector3(1.5*2, 1.6*2, 0); // Adjust the control point2 coordinates
